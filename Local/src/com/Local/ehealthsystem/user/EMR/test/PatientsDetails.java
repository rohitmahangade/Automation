...
//		driver.findElement(By.xpath("//img[@id='saveAllergyNew']")).click();
		driver.findElement(By.xpath("//img[@id='closeNewallergy']")).click();
//******************************************************** Edit Allergies ****************************************************************	
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		Select EditSeverity = new Select(driver.findElement(By.xpath("//select[@id='numlist']")));
...
//		driver.findElement(By.xpath("//img[@id='saveMedicalDevice']")).click();
		driver.findElement(By.xpath("//img[@id='closeNewmedical']")).click();
