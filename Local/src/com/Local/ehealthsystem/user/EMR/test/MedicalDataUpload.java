...
//************************************** Medical Data Upload *********************************************************************		
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@id='fileupload1']")).sendKeys("C:\\Users\\Rohit\\Downloads\\ankit ack.pdf");  //upload file
...
//		driver.findElement(By.xpath("//img[@id='SaveButtonforcardTransNew']")).click();               //Save Button
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//tbody/tr[2]/td[1]/div[2]/span[1]/input[1]")).sendKeys("C:\\\\Users\\\\Rohit\\\\Downloads\\\\ankit ack.pdf");
		Thread.sleep(2000);
...
//****************************************** Medical data Upload ************************************************    	
    	...
    	driver.findElement(By.xpath("//img[@id='NewAdd']")).click();            //Add
    	Thread.sleep(1000);
    	driver.findElement(By.xpath("//input[@id='fileupload1']")).sendKeys("C:\\Users\\Rohit\\Downloads\\ankit ack.pdf");           //Upload
    	Thread.sleep(1000);
...
//		driver.findElement(By.xpath("//button[@id='_SaveDigital']")).click();       //Send
  ...
  //******************************************** Add Allergies ***************************************************  	
    	...
    	Thread.sleep(1000);
    	driver.findElement(By.xpath("//input[@id='fileupload1']")).sendKeys("C:\\\\Users\\\\Rohit\\\\Downloads\\\\ankit ack.pdf");      //File Upload
    	Thread.sleep(1000);
